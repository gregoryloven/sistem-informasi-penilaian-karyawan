...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <a href="#modalCreate" data-toggle='modal' class="btn btn-success btn-xs btn-flat"><i class="fa fa-plus-circle"></i> Tambah Jabatan</a><br><br>
                        ...
                        <table class="table table-bordered" style="text-align: center;" id="myTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$d->nama}}</td>
                                    <td>
                                        <form id="delete-form-{{ $d->id }}" action="{{ route('role.destroy', $d->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
...
<div class="modal fade" id="modalCreate" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" >
            <form role="form" method="POST" action="{{ url('role') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <label>Nama</label>
                            <input type="text" class="form-control" id='nama' name='nama' placeholder="Jabatan" required>
                        </div>
                    </div>
                </div>
